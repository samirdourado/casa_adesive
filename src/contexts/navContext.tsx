...
interface navProviderData {
    ...
    handleTwitter: (pageUrl: string) => void;
};
...
export const NavProvider = ({ children }: Props) => {
    ...
    const handleTwitter = (pageUrl: string) => {
        const twitterUrl: string = `https://twitter.com/intent/tweet?text=${pageUrl}`
